...
public class Products {
    ...
    public Products(String name, String description, Integer quantity, Float price, String image) {
    }

    public Products(String name, String description, Integer quantity, Float price, String image, Long subcategoryid) {
    }
