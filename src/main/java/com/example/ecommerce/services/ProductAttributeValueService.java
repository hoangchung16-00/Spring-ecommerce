...
public class ProductAttributeValueService {
    ...
    @Transactional
    public ProductAttributeValues getSizeByProductId(Long productId,Long colorId){
        return productAttributeValueRepository.getSizeByProductId(productId,"size",colorId);
    }
}
